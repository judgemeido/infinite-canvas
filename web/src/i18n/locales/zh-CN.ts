export default {
    ...
    imageWorkbench: {
        ...
        source: "生图工作台",
        unsupportedAsset: "生图工作台目前只能使用文本资产",
        missingResult: "接口没有返回图片",
        empty: "还没有生成图片",
        resultAlt: "生成结果 {{count}}",
        countWarning: "本站单次最多生成 20 张图，请合理设置张数。",
    },
    videoWorkbench: {
        title: "视频创作台",
    ...
    levels: {
        badge: "互动闯关",
        subtitle: "把古人的诗词，指挥 AIGC 绘成大片级画卷。选一关，开始创作。",
        levelNo: "第 {{order}} 关",
        start: "开始挑战",
        replay: "再玩一次",
        back: "返回关卡",
        comingSoon: "更多关卡，敬请期待",
        status: {
            completed: "已通关",
            open: "可挑战",
            locked: "未解锁",
    ...
    poemChain: {
        title: "古诗词大闯关",
        subtitle: "选年级、挑难度，答题赢积分：每局 15 题、每题一次机会，答错即公布答案，最后由 AI 公平结算总分。",
        pickGrade: "请选择你的年级",
        gradeNo: "{{grade}} 年级",
        bankHint: "题库 {{count}} 题",
        gradeSubtitle: "{{grade}} 年级：选好难度开始，15 题一局，每题一次机会。",
        backToGrades: "重选年级",
        backToDifficulty: "重选难度",
        pickDifficulty: "选择 {{grade}} 年级的挑战难度",
        difficulty: {
            easy: "简单",
            normal: "普通",
            hard: "困难",
        ...
        difficultyDesc: {
            easy: "接龙、识句等基础题型，轻松上手",
            normal: "全题型混合，难度适中",
            hard: "偏重理解、推理与多选，冲击高分",
        },
        perQuestion: "每题 {{points}} 分",
        pointsUnit: "分",
        progress: "第 {{current}} / {{total}} 题",
        score: "本局 {{count}} 分",
        totalScore: "累计总分 {{score}} 分",
        roundsPlayed: "已闯 {{count}} 局",
        resetScore: "重置关卡",
        resetConfirm: "确定重置关卡、清空累计积分和局数吗？",
        ai: {
            title: "AI 智能结算中…",
            subtitle: "正在按公平算法计算本局积分",
            step1: "读取作答记录：答对 {{correct}} / {{total}} 题",
            step2: "评估题目难度：{{label}} ×{{weight}}",
            step3: "计算年级权重：{{grade}} 年级 ×{{weight}}",
            step4: "准确率加成：{{accuracy}}% ×{{bonus}}",
            step5: "汇总生成公平总分…",
            done: "结算完成",
            result: "本局公平积分",
        },
        ...
        multiTag: "多选题",
        submit: "提交答案",
        correct: "答对啦，+{{points}} 分！出自{{source}}",
        wrongAnswer: "答错了，正确答案：{{answer}}",
        answerFrom: "出自{{source}}",
        next: "下一题",
        finish: "查看成绩",
        completeTitle: "本局结束",
        completeDesc: "{{label}}·{{grade}} 年级：答对 {{count}} / {{total}} 题，AI 公平结算得 {{score}} 分。",
        completeTotal: "累计总分 {{score}} 分 · 已闯 {{rounds}} 局",
        playAgain: "再来一局",
    },
    topNav: {
        openMenu: "打开导航菜单",
