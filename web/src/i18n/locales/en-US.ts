export default {
    ...
    imageWorkbench: {
        ...
        source: "Image Studio",
        unsupportedAsset: "Image Studio currently only supports text assets",
        missingResult: "The API returned no image",
        empty: "No images generated yet",
        resultAlt: "Generated image {{count}}",
        countWarning: "This site generates at most 20 images per run; please set a reasonable count.",
    },
    videoWorkbench: {
        title: "Video Studio",
    ...
    levels: {
        ...
        subtitle: "Turn classic Chinese poems into cinematic scrolls with AIGC. Pick a level and start creating.",
        levelNo: "Level {{order}}",
        ...
        complete: {
            title: "🎉 Level Cleared",
            desc: "You completed \u300c{{name}}\u300d and turned the poem into a scroll!",
            stay: "Keep Creating",
            back: "Back to Levels",
        },
    },
    poemChain: {
        title: "古诗词大闯关",
        subtitle: "Pick a grade and difficulty, then earn points: 15 questions per round, one shot each — a wrong pick reveals the answer, and an AI fairly settles your final score.",
        pickGrade: "Choose your grade",
        gradeNo: "Grade {{grade}}",
        bankHint: "{{count}} in bank",
        gradeSubtitle: "Grade {{grade}}: pick a difficulty to start — 15 questions a round, one chance each.",
        backToGrades: "Change grade",
        backToDifficulty: "Change difficulty",
        pickDifficulty: "Pick the difficulty for Grade {{grade}}",
        difficulty: {
            easy: "Easy",
            normal: "Normal",
            hard: "Hard",
        ...
        difficultyDesc: {
            easy: "Basic types like chaining and line ID — easy start",
            normal: "All single-choice types mixed, medium challenge",
            hard: "Meaning, reasoning and multi-select — go for high scores",
        },
        perQuestion: "{{points}} pts each",
        pointsUnit: "pts",
        progress: "{{current}} / {{total}}",
        score: "{{count}} pts this round",
        totalScore: "Total {{score}} pts",
        roundsPlayed: "{{count}} rounds",
        resetScore: "Reset level",
        resetConfirm: "Reset the level and clear your total score and round count?",
        ai: {
            title: "AI settling your score…",
            subtitle: "Computing this round with a fair algorithm",
            step1: "Reading answers: {{correct}} / {{total}} correct",
            step2: "Rating difficulty: {{label}} ×{{weight}}",
            step3: "Grade weight: Grade {{grade}} ×{{weight}}",
            step4: "Accuracy bonus: {{accuracy}}% ×{{bonus}}",
            step5: "Aggregating the fair total…",
            done: "Settlement done",
            result: "Fair score",
        },
        type: {
            chain: "Chain",
            meaning: "Guess by meaning",
            identify: "Name the poem",
            author: "Author's line",
            byAuthor: "Guess the author",
            byDynasty: "Guess the dynasty",
            multi: "Multi-select",
        },
        multiTag: "Multi-select",
        submit: "Submit",
        correct: "Correct! +{{points}} pts · From {{source}}",
        wrongAnswer: "Wrong. Answer: {{answer}}",
        answerFrom: "From {{source}}",
        next: "Next",
        finish: "See result",
        completeTitle: "Round complete",
        completeDesc: "{{label}} · Grade {{grade}}: {{count}} / {{total}} right, AI fair score {{score}} pts.",
        completeTotal: "Total {{score}} pts · {{rounds}} rounds played",
