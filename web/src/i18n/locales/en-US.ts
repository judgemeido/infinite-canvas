export default {
    ...
    poemChain: {
        title: "诗词接龙",
        subtitle: "Read the first line and pick the correct next line; clear them all to pass.",
        progress: "{{current}} / {{total}}",
        score: "{{count}} correct",
        prevLine: "First line",
        pickNext: "Pick the correct next line:",
        correct: "Correct! From {{source}}",
        wrong: "Try again~",
        restart: "Restart",
        completeDesc: "You got {{count}} / {{total}} right and cleared the chain level!",
